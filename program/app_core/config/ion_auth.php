 ...
 */
$config['site_title']                 = "WebPurse.org";       // Site Title, example.com
$config['admin_email']                = "info@webpurse.org"; // Admin Email, admin@example.com
...
$config['identity_cookie_name'] = 'user_me';
